...
enum class PartOfSpeech(
    ...
    companion object {
        fun fromInt(value: Int): PartOfSpeech = entries.find { it.value == value } ?: UNKNOWN

        fun fromShortName(name: String): PartOfSpeech = entries.find { it.shortName == name.lowercase() } ?: UNKNOWN
    }
}
