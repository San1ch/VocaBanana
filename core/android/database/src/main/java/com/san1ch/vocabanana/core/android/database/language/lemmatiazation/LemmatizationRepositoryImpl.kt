...
class LemmatizationRepositoryImpl @Inject constructor(
    ...
    override suspend fun getLemmasForWords(words: List<String>) = lemmaDao.getLemmasForWords(words)
    ...
    override suspend fun getWordLemmaPairs(words: List<String>) = lemmaDao.getWordLemmaPairs(words)

    override suspend fun findExistingLemmas(words: List<String>) = lemmaDao.findExistingLemmas(words)

    override suspend fun findExistingWords(words: List<String>): List<String> = lemmaDao.findExistingWords(words)
}
